{self, ...}: {
  ...
  in {
    ...
    # For X11 apps to function properly
    ...
    in ''
      ...
      // Autostart
      spawn-at-startup "${voctaliaShell}";
      ...
      binds {
        ...
        Mod+Ctrl+Up hotkey-overlay-title="Increase brightness by 3%" allow-when-locked=true {
          spawn "${voctaliaShell}" "msg" "brightness-up" "current" "3";
        }
        Mod+Ctrl+Down hotkey-overlay-title="Decrease brightness by 3%" allow-when-locked=true {
          spawn "${voctaliaShell}" "msg" "brightness-down" "current" "3";
        }
